<!-- Sidebar -->
<aside class="w-64 bg-blue-900 text-white flex flex-col"> {{-- Tambahkan h-full di sini --}}
    ...
    <nav class="flex-grow p-4 space-y-2">
        ...
        <a href="#" {{-- Ganti dengan route('admin.profil-desa.index') --}}
           class="flex items-center px-4 py-2 rounded-md transition-colors duration-200
           {{ request()->routeIs('admin.profil-desa.*') ? 'bg-blue-700' : 'hover:bg-blue-700' }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('berita.index') }}"
           class="flex items-center px-4 py-2 rounded-md transition-colors duration-200
           {{ request()->routeIs('admin.berita.*') ? 'bg-blue-700' : 'hover:bg-blue-700' }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="#" {{-- Ganti dengan route('admin.perangkat-desa.index') --}}
           class="flex items-center px-4 py-2 rounded-md transition-colors duration-200
