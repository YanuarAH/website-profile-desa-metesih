...
@section('content')
<div class="max-w-full"> {{-- Tambahkan max-w-full untuk mencegah overflow --}}
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    <div class="flex items-center p-2 bg-blue-50 rounded-lg">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <p class="text-sm text-gray-700 truncate">{{ $profilDesa->batas_utara }}</p>
                                        </div>
                                    </div>
                                    <div class="flex items-center p-2 bg-red-50 rounded-lg">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <p class="text-sm text-gray-700 truncate">{{ $profilDesa->batas_selatan }}</p>
                                        </div>
                                    </div>
                                    <div class="flex items-center p-2 bg-green-50 rounded-lg">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <p class="text-sm text-gray-700 truncate">{{ $profilDesa->batas_timur }}</p>
                                        </div>
                                    </div>
                                    <div class="flex items-center p-2 bg-yellow-50 rounded-lg">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <p class="text-sm text-gray-700 truncate">{{ $profilDesa->batas_barat }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                                    <div class="bg-gradient-to-r from-indigo-600 to-purple-600 px-4 py-3">
                                        <h4 class="text-white font-semibold flex items-center">
                                            ...
                                            <span class="truncate">Dusun {{ $dusun->nama_dusun }}</span>
                                        </h4>
                                    </div>
                                    <div class="p-4">
                                        @if($dusun->rws->count() > 0)
                                            <div class="space-y-3 max-h-64 overflow-y-auto"> {{-- Tambahkan scroll --}}
